...
const ContactPage = () => {
    return (
        <div className="pt-20">
            {/* Page Header */}
            <section className="py-20 bg-gradient-to-br from-india-blue-800 via-india-saffron-600 to-india-blue-700 relative overflow-hidden z-0">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            { icon: <FaMapMarkerAlt className="text-3xl" />, title: 'Address', info: 'Mumbai, Maharashtra', subtitle: 'Visit our office' },
                            { icon: <FaClock className="text-3xl" />, title: 'Working Hours', info: '9:00 AM - 8:00 PM', subtitle: 'Mon to Saturday' },
                        ].map((item, index) => (
                            <motion.div
                                key={index}
                                initial={{ opacity: 0, y: 30 }}
                            ...
                            >
                                <div className="text-india-blue-600 flex justify-center mb-4">
                                    {item.icon}
                                </div>
                                <h3 className="font-bold text-gray-800 mb-2">{item.title}</h3>
                                <p className="text-india-blue-700 font-semibold mb-1">{item.info}</p>
